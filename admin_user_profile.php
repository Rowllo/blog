	...
	<div>
		...
		<div style="height:70px;background-color:black;">
			...
			<h3 class="span" style="float:right;color:blue;margin-top:-35px;margin-right:50px;">
				<a href="user_delete.php?type=user&id=<?php echo $value['userid'] ?>">
				<input type="button" name="save" value="Delete" style="float:right;margin-right:0px;height:30px;width:80px;color:white;background-color:blue;margin-top:-8px;">
				</a>
			</h3>
